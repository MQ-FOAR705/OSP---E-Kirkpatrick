...
\begin{tabular}{|l|p{6.5cm}|p{6.5cm}|}
\hline
\textbf{Nr.} & \textbf{(Executable) software metadata description} & \textbf{Details} \\
\hline
S1 & Current software version & v1.0 \\
\hline
S2 & Permanent link to executables of this version  &  $https://github.com/MQ-FOAR705/E-Kirkpatrick-PoC-project \\
\hline
S3 & Legal Software License & GNU General Public License (version 3) \\
\hline
S4 & Computing platforms/Operating Systems & Windows (7 or later), macOS (10.11 or later) and Linux. \\
\hline
S5 & Installation requirements \& dependencies & Internet must be available for browser to work successfully. Zotero must be successfully downloaded prior.  \\
\hline
...
\hline
S7 & Support email for questions & ellen.kirkpatrick@students.mq.edu.au \\
\hline
\end{tabular}
